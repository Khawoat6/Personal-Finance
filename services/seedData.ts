...
export const DEFAULT_BOOK_REVIEWS: BookReview[] = [
    {
        ...
        keyTakeaways: ["Financial success is less about what you know and more about how you behave.", "Luck and risk are powerful forces. Be humble in success and forgiving in failure.", "The highest dividend money pays is the ability to control your own time."],
        coreIdeas: [{ concept: "No One's Crazy", explanation: "Your personal experiences with money shape your financial worldview.", relevance: "It teaches empathy and helps us understand that there's no single 'right' answer in finance."}],
        frameworks: [{ name: "Man in the Car Paradox", description: "When we see someone in a fancy car, we rarely think, 'Wow, that person is cool.' Instead, we think, 'Wow, if I had that car, people would think I'm cool.'"}],
        quotes: [{ text: "The ability to do what you want, when you want, with who you want, for as long as you want, is priceless.", context: "On defining the ultimate goal of wealth." }],
        reflections: "This book fundamentally changed how I view wealth and happiness. It’s less of a 'how-to' guide and more of a 'how-to-think' guide.",
        whoShouldRead: ["Anyone looking to build a healthier, less anxious relationship with money.", "Investors who focus too much on charts and not enough on behavior."],
        qualitativeRating: { insightDepth: 5, practicality: 5, timelessness: 5 },
        verdict: "A foundational read that will remain relevant for decades.",
    ...
    },
    {
        ...
        keyTakeaways: ["Homo Sapiens conquered the world thanks to our unique ability to believe in collective fictions like gods, nations, and money.", "The Agricultural Revolution was 'history's biggest fraud.'"],
        coreIdeas: [{ concept: "The Cognitive Revolution", explanation: "Around 70,000 years ago, Sapiens developed new ways of thinking and communicating, primarily through the ability to discuss fictional entities.", relevance: "This is the foundation of modern society. Companies, laws, and nations are all inter-subjective realities (fictions) we collectively agree to uphold."}],
        frameworks: [{ name: "The Three Great Revolutions", description: "Human history is framed by: The Cognitive Revolution, The Agricultural Revolution, and The Scientific Revolution."}],
        quotes: [{ text: "You could never convince a monkey to give you a banana by promising him limitless bananas after death in monkey heaven.", context: "Explaining the unique human ability to believe in abstract concepts."}],
        reflections: "Sapiens provides a powerful macro-lens through which to view not just history, but our current world.",
        whoShouldRead: ["Anyone curious about the deep history of our species.", "Thinkers who want to understand the foundational structures of society."],
        qualitativeRating: { insightDepth: 5, practicality: 3, timelessness: 5 },
        verdict: "An essential, mind-expanding read that provides a crucial context for understanding the world we live in today.",
    ...
    },
    {
        ...
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1317793965l/11468377.jpg',
        category: 'Psychology',
        readingTime: 15,
        difficulty: 'Advanced',
        tagline: 'An exploration of the two systems that drive the way we think.',
        keyTakeaways: ['System 1 is fast, intuitive, and emotional; System 2 is slower, more deliberative, and more logical.', 'Cognitive biases affect our judgment.'],
        coreIdeas: [{ concept: 'WYSIATI (What You See Is All There Is)', explanation: 'System 1 excels at constructing the best possible story from the ideas currently activated, but it does not allow for information it does not have.', relevance: 'We often make decisions without considering all the evidence.' }],
        frameworks: [{ name: 'Prospect Theory', description: 'People make decisions based on the potential value of losses and gains rather than the final outcome.' }],
        quotes: [{ text: 'We are prone to overestimate how much we understand about the world and to underestimate the role of chance in events.', context: 'On the illusion of understanding.' }],
        reflections: 'A dense but incredibly rewarding read that changes how you think about thinking itself.',
        whoShouldRead: ['Decision makers', 'Psychology students', 'Anyone interested in human cognition'],
        qualitativeRating: { insightDepth: 5, practicality: 4, timelessness: 5 },
        verdict: 'A masterpiece on human rationality and irrationality.',
        dateRead: '2023-01-10T00:00:00.000Z',
    },
    {
        id: 'br-4',
        title: 'The Lean Startup',
        author: 'Eric Ries',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1333576876l/10127019.jpg',
        category: 'Business',
        readingTime: 6,
        difficulty: 'Intermediate',
        tagline: "How Today's Entrepreneurs Use Continuous Innovation to Create Radically Successful Businesses.",
        keyTakeaways: ['The Build-Measure-Learn feedback loop is crucial.', 'Use a Minimum Viable Product (MVP) to test hypotheses.'],
        coreIdeas: [{ concept: 'Validated Learning', explanation: 'A rigorous method for demonstrating progress when one is embedded in the soil of extreme uncertainty.', relevance: "It's not about building stuff, but about learning what to build." }],
        frameworks: [{ name: 'Build-Measure-Learn', description: 'A feedback loop for turning ideas into products, measuring customer reactions, and then deciding whether to pivot or persevere.' }],
        quotes: [{ text: 'The only way to win is to learn faster than anyone else.', context: 'On competitive advantage.' }],
        reflections: 'Essential reading for anyone in the tech or startup world.',
        whoShouldRead: ['Entrepreneurs', 'Product managers', 'Innovators in large companies'],
        qualitativeRating: { insightDepth: 4, practicality: 5, timelessness: 4 },
        verdict: 'The modern playbook for building a business from the ground up.',
        dateRead: '2022-09-05T00:00:00.000Z',
    },
    {
        id: 'br-5',
        title: 'Zero to One',
        author: 'Peter Thiel',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1414347376l/18050143.jpg',
        category: 'Business',
        readingTime: 4,
        difficulty: 'Intermediate',
        tagline: 'Notes on Startups, or How to Build the Future.',
        keyTakeaways: ['Competition is for losers. Aim for monopoly.', 'Technology is the only way to create new wealth.', 'A bad plan is better than no plan.'],
        coreIdeas: [{ concept: 'Contrarian Question', explanation: 'What important truth do very few people agree with you on?', relevance: 'The answer can be the basis of a great business.' }],
        frameworks: [],
        quotes: [{ text: "The most contrarian thing of all is not to oppose the crowd but to think for yourself.", context: 'On independent thought.' }],
        reflections: 'A thought-provoking and contrarian take on innovation and startups.',
        whoShouldRead: ['Founders', 'Venture capitalists', 'Technologists'],
        qualitativeRating: { insightDepth: 5, practicality: 3, timelessness: 4 },
        verdict: 'A concise and powerful guide to thinking about building the future.',
        dateRead: '2023-08-21T00:00:00.000Z',
    },
    {
        id: 'br-6',
        title: 'Meditations',
        author: 'Marcus Aurelius',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1421328136l/30659.jpg',
        category: 'Philosophy',
        readingTime: 5,
        difficulty: 'Beginner',
        tagline: 'A series of personal writings by the Roman Emperor on Stoic philosophy.',
        keyTakeaways: ["You have power over your mind - not outside events.", "The happiness of your life depends upon the quality of your thoughts.", "Waste no more time arguing about what a good man should be. Be one."],
        coreIdeas: [{ concept: 'The Dichotomy of Control', explanation: 'Some things are in our control, while others are not.', relevance: 'Focus your energy on what you can control: your own thoughts and actions.' }],
        frameworks: [],
        quotes: [{ text: 'Very little is needed to make a happy life; it is all within yourself, in your way of thinking.', context: 'On inner peace.' }],
        reflections: 'Timeless wisdom on how to live a virtuous and tranquil life. Incredibly relevant even today.',
        whoShouldRead: ['Anyone seeking inner peace', 'Leaders', 'Students of philosophy'],
        qualitativeRating: { insightDepth: 5, practicality: 5, timelessness: 5 },
        verdict: 'An essential guide to the art of living.',
        dateRead: '2021-12-30T00:00:00.000Z',
    },
    {
        id: 'br-7',
        title: 'The Intelligent Investor',
        author: 'Benjamin Graham',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1409598134l/106835.jpg',
        category: 'Finance',
        readingTime: 20,
        difficulty: 'Advanced',
        tagline: 'The Definitive Book on Value Investing.',
        keyTakeaways: ['Mr. Market is your servant, not your guide.', 'An investment operation is one which, upon thorough analysis, promises safety of principal and an adequate return.', 'Always invest with a margin of safety.'],
        coreIdeas: [{ concept: 'Margin of Safety', explanation: 'The difference between the intrinsic value of a stock and its market price.', relevance: 'It is the central concept of value investing, providing a buffer against errors in judgment or bad luck.' }],
        frameworks: [{ name: 'Mr. Market Allegory', description: 'Treat the market as a moody business partner who offers to buy or sell shares at prices that swing between euphoria and despair.' }],
        quotes: [{ text: 'The investor\'s chief problem—and even his worst enemy—is likely to be himself.', context: 'On emotional discipline.' }],
        reflections: 'The bible of value investing. Dense and dated in examples, but the principles are eternal.',
        whoShouldRead: ['Serious investors', 'Finance professionals', 'Anyone wanting to understand stock market fundamentals'],
        qualitativeRating: { insightDepth: 5, practicality: 4, timelessness: 5 },
        verdict: 'The foundational text for value investing that has created generations of successful investors.',
        dateRead: '2023-03-12T00:00:00.000Z',
    },
    {
        id: 'br-8',
        title: 'Influence: The Psychology of Persuasion',
        author: 'Robert B. Cialdini',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1399823611l/28815.jpg',
        category: 'Psychology',
        readingTime: 7,
        difficulty: 'Intermediate',
        tagline: 'Learn the six universal principles of persuasion.',
        keyTakeaways: ['Reciprocity', 'Commitment and Consistency', 'Social Proof', 'Liking', 'Authority', 'Scarcity'],
        coreIdeas: [],
        frameworks: [{ name: 'Six Principles of Influence', description: 'A framework explaining the psychological triggers that lead to compliance.' }],
        quotes: [],
        reflections: 'A fascinating look at the psychology behind why people say "yes".',
        whoShouldRead: ['Marketers', 'Salespeople', 'Negotiators', 'Anyone wanting to be less susceptible to manipulation'],
        qualitativeRating: { insightDepth: 4, practicality: 5, timelessness: 5 },
        verdict: 'A classic and essential book on understanding human behavior and persuasion.',
        dateRead: '2022-05-25T00:00:00.000Z',
    },
    {
        id: 'br-9',
        title: 'Atomic Habits',
        author: 'James Clear',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1535115320l/40121378.jpg',
        category: 'Self-Help',
        readingTime: 5,
        difficulty: 'Beginner',
        tagline: 'An Easy & Proven Way to Build Good Habits & Break Bad Ones.',
        keyTakeaways: ['Focus on 1% improvements daily.', 'Habits are the compound interest of self-improvement.', 'The Four Laws of Behavior Change: Make it Obvious, Attractive, Easy, and Satisfying.'],
        coreIdeas: [],
        frameworks: [{ name: 'The Four Laws of Behavior Change', description: 'A simple set of rules we can use to build better habits.' }],
        quotes: [{ text: 'You do not rise to the level of your goals. You fall to the level of your systems.', context: 'On the importance of systems over goals.' }],
        reflections: 'The most practical and actionable book on habits I have ever read.',
        whoShouldRead: ['Anyone looking to make positive changes in their life', 'Athletes', 'Entrepreneurs'],
        qualitativeRating: { insightDepth: 4, practicality: 5, timelessness: 4 },
        verdict: 'A supremely practical guide to building good habits and breaking bad ones.',
        dateRead: '2023-10-01T00:00:00.000Z',
    },
    {
        id: 'br-10',
        title: 'Principles: Life and Work',
        author: 'Ray Dalio',
        coverImageUrl: 'https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1500918195l/34536488.jpg',
        category: 'Business',
        readingTime: 18,
        difficulty: 'Advanced',
        tagline: 'Dalio shares the unconventional principles that he\'s developed, refined, and used over the past forty years.',
        keyTakeaways: ['Embrace reality and deal with it.', 'Use the 5-Step Process to get what you want out of life.', 'Be radically open-minded and radically transparent.'],
        coreIdeas: [{ concept: 'Idea Meritocracy', explanation: 'A system that brings together smart, independent thinkers and has them productively disagree to come up with the best possible collective thinking and resolve their disagreements in a believable way.', relevance: 'It is the best system for making decisions.' }],
        frameworks: [],
        quotes: [],
        reflections: 'A unique look into the mind of one of the world\'s most successful investors and entrepreneurs.',
        whoShouldRead: ['Leaders', 'Investors', 'Anyone interested in building effective systems'],
        qualitativeRating: { insightDepth: 5, practicality: 4, timelessness: 4 },
        verdict: 'A powerful manual for rational thinking and building a successful organization.',
        dateRead: '2022-02-18T00:00:00.000Z',
    }
];
...
export const generateSeedData = (): AppData => {
    ...
    const visionBoardItems: VisionBoardItem[] = [
        ...
        { id: "vb-8", year: new Date().getFullYear(), imageUrl: 'https://images.unsplash.com/photo-1599818498358-b17242228585?q=80&w=800', title: 'Helicopter Ski Trip', notes: 'Experience heli-skiing in the Alps.', order: 3, categoryId: 'vbcat-3', achieved: false },
